class CartDrawer extends HTMLElement {
  ...
  open(triggeredBy) {
    ...
    this.addEventListener(
      'transitionend',
      () => {
        const emptyState = this.querySelector('.drawer__empty-state:not([hidden])');
        const containerToTrapFocusOn = emptyState || document.getElementById('CartDrawer');
  ...
  renderContents(parsedState) {
    ...
    setTimeout(() => {
      ...
      // This needs to happen AFTER sections are rendered
